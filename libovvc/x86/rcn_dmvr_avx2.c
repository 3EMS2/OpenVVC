             ...
             int16_t dmvr_stride, int16_t pb_w, int16_t pb_h)
{
  ...
  for (i = 0; i < (pb_h >> 1); ++i) {
      __m256i x = _mm256_loadu_si256((__m256i *)&ref0[0]);
      __m256i y = _mm256_loadu_si256((__m256i *)&ref1[0]);
      x = _mm256_abs_epi16(_mm256_sub_epi16(x, y));
      __m128i x1 = _mm_add_epi16(_mm256_extracti128_si256(x, 0),_mm256_extracti128_si256(x, 1));
...
void
rcn_init_dmvr_functions_avx2(struct RCNFunctions *const rcn_funcs)
{
